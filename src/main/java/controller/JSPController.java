        ...
        if(action == null){
           ...
           switch(action){
                case "Connexion":{
                    ...
                    nbGuesses = 0;
                    réponse = r.nextInt(101);
                    
                    request.getSession(true).setAttribute("nbGuesses", nbGuesses);
                    request.getSession(true).setAttribute("answer", réponse);
                ...
                case "Deviner":{
                    ...
                    if(guess == réponse){
                        ...
                        if(finalscore == null || finalscore.getNbGuesses()> nbGuesses){
                            finalscore = new Score(playerName, nbGuesses);
                            
                            request.setAttribute("isNewRecord", true);
                            getServletContext().setAttribute("highScore", finalscore);
                        }else{
